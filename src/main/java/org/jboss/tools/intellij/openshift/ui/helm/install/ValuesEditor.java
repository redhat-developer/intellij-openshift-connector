...
class ValuesEditor extends JPanel {

  private final Project project;
  private Editor editor;
  private DocumentListener listener;

  ValuesEditor(Project project) {
    super(new MigLayout(
  ...
  private Editor createYamlEditor(String content, Project project) {
    String filename = new Random().nextInt() + ".tmp";
    ...
    if (chartValues != null) {
      ...
      add(chartValues.getComponent(), "pushx, growx, pushy, growy, height 400");
