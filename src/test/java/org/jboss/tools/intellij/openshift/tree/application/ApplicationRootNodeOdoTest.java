...
public class ApplicationRootNodeOdoTest {
  ...
  public void before() throws IOException {
    ...
    this.rootNodeOdo = new ApplicationRootNodeOdo(odo, rootNode, fileOperations);
  }
  ...
  public void createComponent_should_NOT_create_files_and_copy_them_if_starter_is_blank() throws IOException {
    ...
    String starter = null;
    // when
    rootNodeOdo.createComponent(project, componentType, registryName, component, source, devfile, starter);
    // then
    verify(odo).createComponent(project, componentType, registryName, component, source, devfile, starter);
  ...
  public void createComponent_should_create_files_copy_and_refresh_them_if_starter_is_NOT_blank() throws IOException {
    ...
    rootNodeOdo.createComponent(project, componentType, registryName, component, source, devfile, starter);
    // then
    verify(odo).createComponent(project, componentType, registryName, component, tempDir.getAbsolutePath(), devfile, starter);
